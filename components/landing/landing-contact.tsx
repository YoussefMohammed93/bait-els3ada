      ...
      <div className="w-full max-w-[1360px] mx-auto px-4 sm:px-5">
        <div className="max-w-xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button
              size="lg"
              className="rounded-full text-lg px-8 py-6 shadow-soft w-full sm:w-auto"
              asChild
            >
              <a
            ...
            <Button
              size="lg"
              variant="outline"
              className="rounded-full shadow-none text-lg px-8 py-6 w-full sm:w-auto border-primary/30 text-foreground hover:bg-accent"
              asChild
            >
